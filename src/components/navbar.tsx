...
export default function NavBar() {
    return (
     <aside className="h-screen w-64 bg-cyan-950 text-white flex flex-col border-r border-slate-800 sticky top-0 border-gray-200 shadow-lg">
            <Link 
                  href="/dashboard" 
                  className="mx-auto rounded-full w-24 h-24 bg-white overflow-hidden mt-5"
                >
                </Link>
